<!DOCTYPE html>
 <html lang="zxx">
    ...
    <head>
        ...
        <meta name="keywords" content="ENERMA Energy Management" />
        <meta name="description" content="Enerma Official Landing Page" />
        <meta name="author" content="" />

        <!-- Title  -->
        <title>Home | Enerma</title>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="o-hidden mw-800">
                                        <h3>Can be trusted Electricity Consulting</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="info section-padding">
                            ...
                            <ul class="info-list">
                                <li><i class="fas fa-check"></i> <p>Trusted electricity consultation.</p> </li>
                                <li><i class="fas fa-check"></i> <p>Design and planning for home or small industrial electricity</p> </li>
                                <li><i class="fas fa-check"></i> <p>Custom IoT based energy management system product</p> </li>
                                <li><i class="fas fa-check"></i> <p>Audit and Inspection for home or small industrial electricity</p> </li>
                            </ul>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12 ">
                        <div class="box-icon-left items">
                            <span class="icon"><i class="fa fa fa-microchip"></i></span>
                            <div class="cont">
                                <h5 class="mb-10">IoT Hardware Development</h5>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="box-icon-left items">
                            ...
                            <div class="cont">
                                <h5 class="mb-10">Electricity Consulting</h5>
                                <p class="pb-10">A decade ago, we founded Melinda with the goal of creating meaningful digital experiences.</p>
                                <a href="#0" class="box-icon-btn"><span>Read More</span></a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12 ">
                        <div class="box-icon-left items">
                            ...
                            <div class="cont">
                                <h5 class="mb-10">IoT and Energy Management Product</h5>
                                <p class="pb-10">A decade ago, we founded Melinda with the goal of creating meaningful digital experiences.</p>
                                <a href="#0" class="box-icon-btn"><span>Read More</span></a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="box-icon-left items">
                            ...
                            <div class="cont">
                                <h5 class="mb-10">Audit and Inspection</h5>
                                <p class="pb-10">A decade ago, we founded Melinda with the goal of creating meaningful digital experiences.</p>
                                <a href="#0" class="box-icon-btn"><span>Read More</span></a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-12 col-xs-12">
                        <div class="box-icon-left items">
                            ...
                            <div class="cont">
                                <h5 class="mb-10">Design and Planning</h5>
                                <p class="pb-10">A decade ago, we founded Melinda with the goal of creating meaningful digital experiences.</p>
                                <a href="#0" class="box-icon-btn"><span>Read More</span></a>
                            </div>
                        </div>
                                ...
                                <div class="item-img-overlay">
                                    <div class="overlay-info full-width">
                                        <div class="cont v-middle">
                                            <a href="https://si.ft.uns.ac.id/enerma-product-1">
                                            	<h3>BEMS</h3>
                                            	<p>IoT based Energy Management Product</p>
                                            </a>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 items design">
                            <div class="item-img">
                                ...
                                <div class="item-img-overlay">
                                    <div class="overlay-info full-width">
                                        <div class="cont v-middle">
                                            <a href="https://si.ft.uns.ac.id/enerma-product-2">
                                                <h3>Smart Powerwall</h3>
                                                <p>IoT based Energy Management Software</p>
                                            </a>
                                        </div>
        ...
        ==== Start video -->
            <section class="video section-padding valign">
                ...
                <div class="container text-center">
                    ...
                    <div class="info">
                        <h5>ENERMA</h5>
                        <h3>We are always concern about energy management for batter life</h3>
                ...
                <div class="row">
                    ...
                    <div class="owl-carousel owl-theme col-lg-12">
                        <div class="item text-center">
                            <div class="info">
                                <h6>Client 1 <span>Scope</span></h6>
                                <div class="img">
                        ...
                        <div class="item text-center">
                            <div class="info">
                                <h6>Client 2 <span>Scope</span></h6>
                                <div class="img">
                        ...
                        <div class="item text-center">
                            <div class="info">
                                <h6>Client 3 <span>Scope</span></h6>
                                <div class="img">
                        ...
                        <div class="item text-center">
                            <div class="info">
                                <h6>Client 4 <span>Scope</span></h6>
                                <div class="img">
                                    <img src="img/clients/1.jpg" alt="">
                                </div>
                            </div>
                        ...
                        <div class="item text-center">
                            <div class="info">
                                <h6>Client 5 <span>Scope</span></h6>
                                <div class="img">
                                    <img src="img/clients/2.jpg" alt="">
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <div class="item row">
                            ...
                            <div class="content col-10 col-sm-10">
                                <h3>E-mail Us</h3></br>
                                <p>Support : cs email</p></br>
                                <p>Sales : business email</p>
                            </div>
                        </div>
                    </div>
                    <!-- <div class="col-lg-8">
        ...
        <footer class="footer">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="mb-md50">
                            ...
                            <ul class="footer-widget-list">
                               <li><a href="">Artikel/Berita Terkait</a></li>
                    ...
                    <div class="col-lg-3">
                        <div class="contact-info">
                            ...
                            <ul>
                                <li> Jl. Ir. Sutami No.36, Kentingan, Kec. Jebres, Kota Surakarta, Jawa Tengah 57126</li>
                                <li>Phone No.</li>
                                <li>E-Mail</li>
                            </ul>
                            <!-- <div class="form-gr">
            ...
            <div class="sub-footer">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <p>Copyright &copy; 2021 Enerma. All Rights Reserved</p>
                        </div>
                        <div class="col-lg-6">
                            <ul class="foot-links">
                                <li><a href="">Home </a></li>
